    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      >
        ...
        <p className="text-lg text-gray-600 leading-relaxed max-w-4xl mx-auto text-left md:text-center">
          My skill set combines strong{' '}
          <span className="font-semibold text-gray-800">
            analytical and research experience
          </span>{' '}
          from my background in physiological science with{' '}
          <span className="font-semibold text-gray-800">
            practical full-stack development foundations
          </span>
          . This unique blend positions me to build reliable, data-driven
          software solutions in health-tech and beyond.
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
        ...
        >
          ...
          <p className="text-sm text-gray-500 mb-4">
            Core competencies I am actively acquiring through my BSCS program.
          </p>
          <div className="flex flex-wrap gap-2">
            {upcomingSkills.map((skill) => (
              <span
                key={skill}
                className="px-3 py-1 bg-white text-gray-600 text-sm font-medium rounded-full border border-gray-200 border-dashed"
              >
                {skill}
              </span>
            ))}
